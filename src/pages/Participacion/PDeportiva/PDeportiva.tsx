...
// Define interfaces for the props
    ...
    <div className="bg-white p-4 rounded-lg shadow-md mb-4">
        ...
        <div className="flex items-center space-x-4">
            ...
            /> */}
            <div>
            <h3 className=" text-gray-800 text-sm">{`Deporte: ${customer.deporte}`}</h3>
    ...
    <div className="bg-white p-6 rounded-lg">
        ...
        <div className="flex items-center space-x-4">
            ...
            />
            <div>
            <h2 className="text-xl font-bold text-gray-900">{customer.deporte}</h2>
...
export default function PDeportiva () {
    ...
    const filteredCustomers = customers.filter(customer =>
        customer.deporte.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    return (
        ...
        <header className="bg-white shadow">
            ...
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold text-gray-900">Participacion Deportiva</h1>
                ...
                <button className="px-4 py-2 text-gray-600 hover:text-gray-900">Actividad Deportiva</button>
                </nav>
            </div>
            </div>
        </header>
